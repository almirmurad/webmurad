// JavaScript Document
		...
		function SetaEventos()
		{
			...
			Elm('msg').onblur = msg_onblur;
			<!--Elm('msg').onkeyup = msg_onkeyup;-->
			
			Elm('form_contato').onsubmit = form_contato_onsubmit;
		}
			...
			function msg_onblur()
				{
					if(Elm('msg').value == '')
						{
							alert('O campo msg está vazio!');
							Elm('msg').focus();
						}
				}	
				
			function form_contato_onsubmit()
				{
					var envia = true;
					...
					envia = campoobrigatorio('msg',envia);
